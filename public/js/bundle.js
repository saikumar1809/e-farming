...
},{"./_collection-weak":"../../node_modules/core-js/modules/_collection-weak.js","./_validate-collection":"../../node_modules/core-js/modules/_validate-collection.js","./_collection":"../../node_modules/core-js/modules/_collection.js"}],"../../node_modules/core-js/internals/global.js":[function(require,module,exports) {
var global = arguments[3];
...
},{"../internals/a-callable":"../../node_modules/core-js/internals/a-callable.js"}],"../../node_modules/core-js/internals/html.js":[function(require,module,exports) {
var getBuiltIn = require('../internals/get-built-in');

module.exports = getBuiltIn('document', 'documentElement');

},{"../internals/get-built-in":"../../node_modules/core-js/internals/get-built-in.js"}],"../../node_modules/core-js/internals/engine-is-ios.js":[function(require,module,exports) {
var userAgent = require('../internals/engine-user-agent');

module.exports = /(?:ipad|iphone|ipod).*applewebkit/i.test(userAgent);

},{"../internals/engine-user-agent":"../../node_modules/core-js/internals/engine-user-agent.js"}],"../../node_modules/core-js/internals/engine-is-node.js":[function(require,module,exports) {
...
},{"../internals/classof-raw":"../../node_modules/core-js/internals/classof-raw.js","../internals/global":"../../node_modules/core-js/internals/global.js"}],"../../node_modules/core-js/internals/task.js":[function(require,module,exports) {
...
},{"../internals/export":"../../node_modules/core-js/internals/export.js","../internals/global":"../../node_modules/core-js/internals/global.js","../internals/task":"../../node_modules/core-js/internals/task.js"}],"../../node_modules/core-js/modules/web.dom.iterable.js":[function(require,module,exports) {
...
var login = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(addhar, password) {
    var res;
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // console.log(res.data.data.user);
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context.t0.response.data.message); //console.log('i am coming here');
...
exports.storeMentorRequest = exports.signupStudent = exports.signupMentor = exports.signupCohortLead = exports.signup = exports.createNewCohort = void 0;
...
var signup = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(name, addhar, email, role, phoneNo, address, password, passwordConfirm) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'team CSP welcomes you!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            } // console.log(res);
...
var storeMentorRequest = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, email, phoneNumber, workingAt, jobRole, question1, question2, question3) {
    var res;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'team E farming  welcomes you!');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            } // console.log(res);
          ...
          case 7:
            _context2.prev = 7;
            _context2.t0 = _context2["catch"](0);
            (0, _alerts.showAlert)('error', _context2.t0.response.data.message); // console.log(err.response);
  ...
  return function storeMentorRequest(_x9, _x10, _x11, _x12, _x13, _x14, _x15, _x16) {
    return _ref2.apply(this, arguments);
  };
}();

exports.storeMentorRequest = storeMentorRequest;

var signupMentor = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3(name, DOB, email, gender, languages, currentCompany, currentJob, phoneNo, qualification, address, password, passwordConfirm) {
    var role, res;
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', _context3.t0.response.data.message); // console.log(err.response);
  ...
  return function signupMentor(_x17, _x18, _x19, _x20, _x21, _x22, _x23, _x24, _x25, _x26, _x27, _x28) {
...
var signupStudent = /*#__PURE__*/function () {
  var _ref4 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee4(name, DOB, email, fatherName, motherName, fatherOccupation, motherOccupation, goal, phoneNo, fatherPhone, motherPhone, siblings, study, school, GPA, mentor, gender, langs, phone, address, password, passwordConfirm) {
    var role, res;
      ...
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Regestration sucessfull🎉');
              window.setTimeout(function () {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context4.t0.response.data.message); // console.log(err);
  ...
  return function signupStudent(_x29, _x30, _x31, _x32, _x33, _x34, _x35, _x36, _x37, _x38, _x39, _x40, _x41, _x42, _x43, _x44, _x45, _x46, _x47, _x48, _x49, _x50) {
...
var signupCohortLead = /*#__PURE__*/function () {
  var _ref5 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee5(name, email, gender, languages, phoneNo, qualification, password, passwordConfirm) {
    var role, res;
      ...
      while (1) {
        switch (_context5.prev = _context5.next) {
          ...
          case 9:
            ...
            (0, _alerts.showAlert)('error', _context5.t0.response.data.message); // console.log(err.response);
  ...
  return function signupCohortLead(_x51, _x52, _x53, _x54, _x55, _x56, _x57, _x58) {
    return _ref5.apply(this, arguments);
  };
}();

exports.signupCohortLead = signupCohortLead;

var createNewCohort = /*#__PURE__*/function () {
  var _ref6 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee6(name, cohortLead, description, images, imageCover) {
    var slug, res;
      ...
      while (1) {
        switch (_context6.prev = _context6.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Cohort created successfully ✔');
              window.setTimeout(function () {
          ...
          case 8:
            ...
            (0, _alerts.showAlert)('error', _context6.t0.response.data.message); // console.log(err.response);
  ...
  return function createNewCohort(_x59, _x60, _x61, _x62, _x63) {
    return _ref6.apply(this, arguments);
  };
}();

exports.createNewCohort = createNewCohort;
},{"axios":"../../node_modules/axios/index.js","./alerts":"alerts.js"}],"farmer.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.submitFarmerComplaint = exports.postAdvertisment = void 0;
...
var submitFarmerComplaint = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(complaint) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'complaint registered!');
              window.setTimeout(function () {
  ...
  return function submitFarmerComplaint(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.submitFarmerComplaint = submitFarmerComplaint;

var postAdvertisment = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2(name, price, quantity) {
    var res, url;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'post success✔');
              url = '';
              if (res.data.data.url == 'farmer') url = '/farmer';else url = '/supplier';
              window.setTimeout(function () {
                location.assign(url);
              }, 1500);
            }
  ...
  return function postAdvertisment(_x2, _x3, _x4) {
    return _ref2.apply(this, arguments);
  };
}();

exports.postAdvertisment = postAdvertisment;
...
var sendAdminTip = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee(tip) {
    var res;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', ' tip sent successfully✔!');
              window.setTimeout(function () {
  ...
  return function sendAdminTip(_x) {
    return _ref.apply(this, arguments);
  };
}();

exports.sendAdminTip = sendAdminTip;
...
var complaintForm = document.querySelector('.form--complaints');
var tipsForm = document.querySelector('.form--tips');
var advertismentForm = document.querySelector('.form--advertisment'); // DELEGATION

if (loginForm) loginForm.addEventListener('submit', function (e) {
  e.preventDefault();
  var addhar = document.getElementById('addhar').value;
  var password = document.getElementById('pwd').value;
  (0, _login.login)(addhar, password);
}); // if (logOutBtn) {
